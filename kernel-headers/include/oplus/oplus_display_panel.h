...
#define PANEL_IOCTL_SET_AOD _IOW(OPLUS_PANEL_IOCTL_BASE, 0x08, unsigned int)
#define PANEL_IOCTL_GET_AOD _IOWR(OPLUS_PANEL_IOCTL_BASE, 0x09, unsigned int)
...
#define PANEL_IOCTL_GET_DIM_ALPHA _IOWR(OPLUS_PANEL_IOCTL_BASE, 0x12, unsigned int)
#define PANEL_IOCTL_SET_DIM_DC_ALPHA _IOW(OPLUS_PANEL_IOCTL_BASE, 0x13, unsigned int)
#define PANEL_IOCTL_GET_DIM_DC_ALPHA _IOWR(OPLUS_PANEL_IOCTL_BASE, 0x14, unsigned int)
...
#define PANEL_IOCTL_SET_ULTRA_LOW_POWER_AOD _IOW(OPLUS_PANEL_IOCTL_BASE, 0x33, unsigned int)
#define PANEL_IOCTL_GET_ULTRA_LOW_POWER_AOD _IOWR(OPLUS_PANEL_IOCTL_BASE, 0x34, unsigned int)
...
#define PANEL_IOCTL_SET_LOW_PWM_AOD _IOWR(OPLUS_PANEL_IOCTL_BASE, 0xD6, unsigned int)
